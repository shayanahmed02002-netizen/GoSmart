...
import { LayoutDashboard, Users, GitBranch, Calendar as CalendarIcon, MessageSquare, Megaphone, Zap, Settings, Menu } from 'lucide-react'
...
export default function Sidebar({ active, onNavigate, collapsed, onToggle }) {
  ...
  return (
    ...
    >
      ...
      <div className="px-2.5 pt-1 pb-2 space-y-1 border-t border-white/10">
