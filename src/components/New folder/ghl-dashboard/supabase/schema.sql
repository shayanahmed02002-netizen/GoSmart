...
-- ---------------------------------------------------------------------------
-- agents  (AI agents built from a user-supplied knowledge base)
-- `documents` is an array of { id, title, content } objects. Retrieval over
-- them happens client-side in dataService.js; this table just persists the
-- knowledge base and agent metadata.
-- ---------------------------------------------------------------------------
