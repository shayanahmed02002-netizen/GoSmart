    ...
    <Card className="p-4">
      ...
      <div className="flex items-center justify-between pt-2.5 border-t border-line">
        <button
          ...
          className={`text-xs font-medium px-2.5 py-1.5 rounded-lg transition-colors ${agent.status === 'active' ? 'text-warn hover:bg-warn-light' : 'text-won hover:bg-won-light'
            }`}
        >
